...
public class HTMLCasaa4Pipeteadores {

	public static void main(String[] args) {
		String ruta="C:\\casetes1\\dispensadoresdeliquidosBrand.xls";
		//String ruta="C:\\casetes1\\pipeteadores.xls";
		  ...
		  do{			   
			     try{ 
			    	 ...
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setMarca(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
				...
				for(int e=0;e<reg.size();e++){
					...
					pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
						...
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</br></div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getMarca());
