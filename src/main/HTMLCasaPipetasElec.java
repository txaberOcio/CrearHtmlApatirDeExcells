...
public class HTMLCasaPipetasElec {

	public static void main(String[] args) {
		//String ruta="C:\\casetes1\\electronicasEpendorrf.xls";
		//String ruta="C:\\casetes1\\electronicasFisher.xls";
		String ruta="C:\\casetes1\\electronicasGilson.xls";
