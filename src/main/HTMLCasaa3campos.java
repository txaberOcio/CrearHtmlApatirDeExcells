...
public class HTMLCasaa3campos {

	public static void main(String[] args) {
		//String ruta="C:\\casetes1\\accesoriosdepipeteado.xls";
		//String ruta="C:\\casetes1\\dispensadoresdeliquidosGilson.xls";
		//String ruta="C:\\casetes1\\dispensadoresdeliquidosEppendorf.xls";
		//String ruta="C:\\casetes1\\AccesoriosMultidispensacion.xls";
		//String ruta="C:\\casetes1\\Multidispensacion.xls";
		//String ruta="C:\\casetes1\\puntasEppendorf.xls";
		//String ruta="C:\\casetes1\\sondas temperaturaLabpro.xls";
		//String ruta="C:\\casetes1\\cuchillas y bisturis labbox.xls";
		//String ruta="C:\\casetes1\\spatulascucharas labbox.xls";
		//String ruta="C:\\casetes1\\spatulascucharas Auxilab.xls";
		//String ruta="C:\\casetes1\\espatula auxilab.xls";
		//String ruta="C:\\casetes1\\cuchara auxilab.xls";
		//String ruta="C:\\casetes1\\espatula labbox.xls";
		//String ruta="C:\\casetes1\\cuchillas y bisturis auxilabb.xls";
		//String ruta="C:\\casetes1\\pinzasauxilab - copiaespeciales.xls";
		//String ruta="C:\\casetes1\\pinzasauxilabCurbasyrectas.xls";
		//String ruta="C:\\casetes1\\pinzasLabbox.xls";
		//String ruta="C:\\casetes1\\otroselementosdedisecciónlabox.xls";
		//String ruta="C:\\casetes1\\otroselementosdedisecciónAuxilabtijeras.xls";
		//String ruta="C:\\casetes1\\otroselementosdedisecciónAuxilaEstuches.xls";
		//String ruta="C:\\casetes1\\otroselementosdedisecciónAuxilaAgujasDiseccion.xls";
		//String ruta="C:\\casetes1\\transporteyalmaenamientodemuestrasAuxilab.xls";
		//String ruta="C:\\casetes1\\bolsas para peligros biologicos y autoclaveDeltalab.xls";
		//String ruta="C:\\casetes1\\bolsas para peligros biologicos y autoclaveFisher.xls";
		//String ruta="C:\\casetes1\\bolsas para peligros biologicos y autoclaveLabbox.xls";
		//String ruta="C:\\casetes1\\guantesbimedica.xls";
		//String ruta="C:\\casetes1\\gafasAuxilab.xls";
		//String ruta="C:\\casetes1\\gafasLabbox.xls";
		//String ruta="C:\\casetes1\\almacenamiento y desecho de materiales peligrosos.xls";
		//String ruta="C:\\casetes1\\toallitas.xls";
		//String ruta="C:\\casetes1\\MecherosLabbox.xls";
		String ruta="C:\\casetes1\\MecherosSelecta.xls";
