...
public class HTMLcito {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\Cito.xls";
		   Cito reg= new Cito();
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(Cito listaRegistrosDefinitiva){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				fichero = new FileWriter("C:\\Users\\PQNSV2\\Desktop\\embudoscitologia.jsp");
				...
				pw.println("<div class=\"container\">\r\n <div class=\"row\">\r\n");
					...
					for(int e=0;e<listaRegistrosDefinitiva.getLista().size();e++){	
						pw.println("<h1 class='prodtitulo2'>"+listaRegistrosDefinitiva.getLista().get(e).getTitu()+"</h1>");
						pw.println("<b class='producdescripcion2'>"+listaRegistrosDefinitiva.getLista().get(e).getDesc()+"</b>");
