...
public class HTMLUltimaEstufa {

	public static void main(String[] args) {
		String ruta="C:\\casetes1\\calefaccionfinal.xls";
	...
	public static void CrearHtml(ArrayList<MedidoresPH> reg){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(0).getFoto()+"a.png'></div></div></div>");
				...
				for(int e=0;e<reg.size();e++){
					...
					if(uu.equals(reg.get(e-1).getFoto())) {}else {
						...
						pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getFoto()+"a.png'></div></div></div>");
					}
					}
