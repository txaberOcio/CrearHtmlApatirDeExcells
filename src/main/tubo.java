...
public class tubo {
	...
	public static void main(String[] args) {
		...
		String ruta="C:\\casetes\\tuvos2.xls";
		   Merck reg= new Merck();
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(Merck listaRegistrosDefinitiva){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				fichero = new FileWriter("C:\\Users\\PQNSV2\\Desktop\\greiner.jsp");
				...
				pw.println("<div class=\"container\">\r\n <div class=\"row\">\r\n");
					...
					pw.println("<tr class='inpar2'><td colspan='4'>");
							...
							pw.println("<tr class=''><th class='th1'></th><th class='th1'>Codigo</th><th class='th1'>Nombre</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
