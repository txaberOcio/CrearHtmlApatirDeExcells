...
public class delta {
	...
	public static void main(String[] args) {
		...
		String ruta="C:\\casetes\\delta.xls";
		   Merck reg= new Merck();
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(Merck listaRegistrosDefinitiva){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				fichero = new FileWriter("C:\\Users\\PQNSV2\\Desktop\\delta.jsp");
				...
				pw.println("<div class=\"container\">\r\n <div class=\"row\">\r\n");
					...
					pw.println("<tr class='inpar2'><td colspan='4'>");
							...
							pw.println("<tr class=''><th class='th1'></th><th class='th1'>Codigo</th><th class='th1'>Nombre</th><th class='th1'>Unidades</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
				...
				pw.println("<tr class=''>");}
				pw.println("<td><img src='foto/"+listaRegistrosDefinitiva.getLista().get(e).getDesc()+".jpg' width='100px' height='100px' class='fotoProductoLupa'></td>");
				...
				pw.println("</td>");
				pw.println("<td class='produccel'><div id=\"divCargau"+e+"\" name=\"divCargau"+e+"\"> </div><div id='borraru"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargau"+e+"`,'DE"+listaRegistrosDefinitiva.getLista().get(e).getCodigo() +"','borraru"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='DE"+listaRegistrosDefinitiva.getLista().get(e).getCodigo()+"'>"+
