...
public class HTMLCasaLabbox{

	public static void main(String[] args) {
		//String ruta="C:\\casetes1\\MICROPIPETAgilsonpack.xls";
		String ruta="C:\\casetes1\\MICROPIPETA Labbox.xls";
		//String ruta="C:\\casetes1\\MICROPIPETAFisher.xls";
		//String ruta="C:\\casetes\1\MICROPIPETAgilsonMonocanal.xls";
		//String ruta="C:\\casetes1\\MICROPIPETAgilsonPluricanal.xls";
		//String ruta="C:\\casetes1\\MICROPIPETAlabnet.xls";
		//String ruta="C:\\casetes1\\MICROPIPETA  auxilab.xls";
				...
				for(int e=0;e<reg.size();e++){
					...
					pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
						...
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getFoto());
