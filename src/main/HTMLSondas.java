...
public class HTMLSondas {

	public static void main(String[] args) {
		
		//String ruta="C:\\casetes\\Conductsobre.xls";
		//String ruta="C:\\casetes\\Conductport.xls";
		//String ruta="C:\\casetes\\ConduvBol.xls";
		String ruta="C:\\casetes\\sondas.xls";
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				for(int e=0;e<reg.size();e++){
					...
					if(e==0 ||! reg.get(e).getTipo().equals(anterior)) {
						pw.println("<h1 class='titulito'>"+reg.get(e).getNombreProducto()+"</h1>");
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getTipo());
							if(!reg.get(e).getMarca().contains("MET")){pw.println(".jpg'>");}
							System.out.println(reg.get(e).getMarca());
							if(reg.get(e).getMarca().contains("MET")){System.out.println("a");pw.println(".png'>");};
							pw.println("</div></div></div>");
