...
public class HTMLCasaTablaVieja3campos {

	public static void main(String[] args) {
	
		String ruta="C:\\casetes1\\termometrosdevarillaLabbox.xls";
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setLetra(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			      reg.add(obj);
...
pw.println("<img  class=''height='250px' width='100%' SRC='fotoproducto/labbox.jpg'>");
pw.println("</div><div class='col-xs-12 col-sm-12 col-md-8 col-lg-6 col-xl-6'>");
pw.println("<table><tbody>");
pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Producto</th><th class='th1'>Detalles</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");;
				...
				pw.println("<tr class='inpar'>");}else{pw.println("<tr clasparpar'>");
							...
							pw.println("<td class='produccel'>"+reg.get(e).getLetra()+"</td>");
