...
public class HTMLohausAgitador {

	public static void main(String[] args) {

		String ruta="C:\\casetes\\ohausAgitadores.xls";
			...
			try {
				...
				for(int e=0;e<reg.size();e++){
					...
					pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getNombreProducto());
