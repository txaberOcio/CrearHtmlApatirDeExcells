...
public class MedidoresdePH {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\PHMEDIDOR2.xls";
				...
				for(int e=0;e<reg.size();e++){
					...
					if(e==0 ||! reg.get(e).getTipo().equals(anterior)) {
						...
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='60%' heiht='60%' src='fotoproducto/"+reg.get(e).getCodigo()+".png'>");
							pw.println("</div></div></div>");
