	...
	public static void CrearHtml(Merck listaRegistrosDefinitiva){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				pw.println("</td>");
				pw.println("<td class='produccel'><div id=\"divCargau"+e+"\" name=\"divCargau"+e+"\"> </div><div id='borraru"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargau"+e+"`,'ME"+listaRegistrosDefinitiva.getLista().get(e).getCodigo() +"','borraru"+e+"')\">Consultar precio</div></td>"+
