...
public class HTMLFisherChemical {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\agilenagujas.xls";
...
int numerito=2;
				...
				//Codigo,Largura,Diametro,Unidades,Espesor.Formato,Tubo,Precio,Comprar
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'FC"+reg.get(e).getCodigo() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='FC"+reg.get(e).getCodigo()+"'>"+
