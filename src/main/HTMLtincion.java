...
import clases.Tincion;



public class HTMLtincion {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\tincion.xls";
		  ArrayList<Tincion> reg= new ArrayList();
		  Tincion obj=new Tincion();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setTituGrupo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setTituGrupo(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setDescGrupo(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    		 }
			    	 ...
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setCodigoUnidad(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setDetalle1(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setDetalle2(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
...
/*
	...
	public static void CrearHtml(ArrayList<Tincion> reg){
			...
			try {
				...
				pw.println("<%@ page language=\"java\" contentType=\"text/html; charset=UTF-8\"\r\n" + 
					...
					for(int e=0;e<reg.size();e++){
						System.out.println(reg.get(e).getTituGrupo());
						
						if(reg.get(e).getGrupo().equals("a")) {
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8'><h1 class='prodtitulo'>"+reg.get(e).getTituGrupo()+"</h1>"+ reg.get(e).getDescGrupo()+"</br></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img  width='150px' height='150px'src='fotoproducto/"+reg.get(e).getFoto()+".jpg' class=''></div></div></div>");
						...
						if(e+1<reg.size()) {
							if(reg.get(e).getGrupo().equals("a")) {
								...
								pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Detalle 1</th><th class='th1'>Detalle 2</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
							}
							}
							...
							pw.println("<td class='produccel'>"+reg.get(e).getCodigoUnidad()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDetalle1()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDetalle2()+"</td>");
							pw.println("<td class='produccel'><div id='divCargar"+e+"' name='divCargar"+e+"'> </div>"+
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'DE"+reg.get(e).getCodigoUnidad() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='DE"+reg.get(e).getCodigoUnidad()+"'>"+
