...
public class HTMLAGilent01 {

	public static void main(String[] args) {
		String ruta="C:\\casetes\\extracciondefasessolidas.xls";
				...
				String tubo;
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setFormato(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setFormato(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setTubo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setTubo(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
...
int numerito=2;
					for(int e=0;e<reg.size();e++){
						...
						if(reg.get(e).getFoto().equals("a")){
							...
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'><h1 class='prodtitulo2'>"+reg.get(e).getCodigo()+"</h1></br></div></div></div>");
							...
							pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Largura</th><th class='th1'>Diametro</th><th class='th1'>Unidades</th><th class='th1'>Espesor</th><th class='th1'>Formato</th><th class='th1'>Tubo</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
						}else {
							if(numerito%2==0) {
				...
				pw.println("<td class='produccel'>"+reg.get(e).getEspesor()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getFormato()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getTubo()+"</td>");				
