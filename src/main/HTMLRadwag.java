...
import clases.Radwag;





public class HTMLRadwag {

	public static void main(String[] args) {
		
		
		//String ruta="C:\\casetes\\ohaus5.xls";
		String ruta="C:\\casetes\\radwag.xls";
		  ArrayList<Radwag> reg= new ArrayList();
		  Radwag obj=new Radwag();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setNombregrupo(String.valueOf(num));
			    		// System.out.println(num);
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setNombregrupo(row.getCell(0).getStringCellValue());
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setCodigo(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setMedidas(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setMedidas(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setPesosoporta(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setPesosoporta(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setGrupo(row.getCell(6).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(ArrayList<Radwag> reg){
...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
							...
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'><h1 class='prodtitulo'>"+reg.get(e).getNombregrupo()+"</h1></br></div></div></div></div>");
							pw.println("<div class='tabla'><table><tbody>");
							pw.println("<tr class=''><th class='th1'>Foto</th><th class='th1'>Codigo</th><th class='th1'>Producto</th><th class='th1'>Tamaño</th><th class='th1'>Peso maximo</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
							}
				...
				pw.println("<td class='produccel'>"+reg.get(e).getPesoNeto()+"</td>");
					*/
							pw.println("<td class='produccel'><img  class=''height='100px'width='100' width='100%' SRC='fotoproducto/"+reg.get(e).getCodigo()+".jpg'>");
							pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getNombreproducto()+"</td>");
							
							pw.println("<td class='produccel'>"+reg.get(e).getMedidas()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getPesosoporta()+"</td>");
				...
				//Codigo,Largura,Diametro,Unidades,Espesor.Formato,Tubo,Precio,Comprar
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'RAD"+reg.get(e).getCodigo() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='RAD"+reg.get(e).getCodigo()+"'>"+
