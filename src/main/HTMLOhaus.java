...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
						...
						if(reg.get(e).getPrimero().equals("a")){
							...
							pw.println("<tr class=''><th class='th1'>Modelo</th><th class='th1'>Codigo</th><th class='th1'>Nombre producto</th><th class='th1'>Peso neto</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
						}
							if(numerito%2==0) {
