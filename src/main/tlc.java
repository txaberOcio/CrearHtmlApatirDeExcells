...
public class tlc {
	...
	public static void main(String[] args) {
		...
		String ruta="C:\\casetes\\tlc.xls";
		  ArrayList<Tlc> reg= new ArrayList();
		   Tlc obj=new Tlc();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setDesc(row.getCell(0).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setFoto(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    		 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setNombre(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(ArrayList<Tlc> reg){
				...
				//aqui empiezo a mter mis cosas
					...
					for(int e=0;e<reg.size();e++){
						System.out.println(e);
							...
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-9'><h1 class='prodtitulo'>"+reg.get(e).getNombre()+"</h1>"+reg.get(e).getDesc()+"</br></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-3'><img src='fotoproducto/"+reg.get(e).getFoto()+".jpg' class='producto'></div></div></div>");
							...
							pw.println("<tr class=''>");
							pw.println("<td class='produccel'>"+reg.get(e).getFoto()+"</td>");
