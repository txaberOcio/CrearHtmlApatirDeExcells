			...
			try {
				...
				for(int e=0;e<reg.size();e++){
					...
					if(e==0 ||! reg.get(e).getTipo().equals(anterior)) {
						pw.println("<h1 class='titulin'>"+reg.get(e).getTipo()+"</h1>");
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='textocontenido' >"+reg.get(e).getDescripcion()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getCodigo()+".jpg'>");
							pw.println("</div></div></div>");
