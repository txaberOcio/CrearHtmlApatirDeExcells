...
public class HTMLConductsobre {

	public static void main(String[] args) {
		//este es bueno
		//String ruta="C:\\casetes\\sobremesa.xls";
		//String ruta="C:\\casetes\\portatil.xls";
		//medidoresmultiparametricosdesobremesa
		//String ruta="C:\\casetes\\Sensoresysondasoxigenodisuelto.xls";
		//String ruta="C:\\casetes\\medidoresmultiparametricosdesobremesa.xls";
		//String ruta="C:\\casetes\\bainostermostaticoscondecirculacion.xls";
		//String ruta="C:\\casetes\\Baños termostáticos de agua.xls";
		//String ruta="C:\\casetes\\Baño ultrasónico.xls";
		//String ruta="C:\\casetes\\centrifugasdesobremesa.xls";
		//String ruta="C:\\casetes\\microcentrifugas.xls";
		//String ruta="C:\\casetes\\Minicentrifugas.xls";
		//String ruta="C:\\casetes\\centrifugasdelavado.xls";
		//String ruta="C:\\casetes\\centrifugasplacasPCR.xls";
		//String ruta="C:\\casetes\\rotors.xls";
		String ruta="C:\\casetes\\Accesorios.xls";
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				pw.println("<table align='center' class='stilosTabla'><tr class='contenido'>");
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'"+reg.get(e).getMarca()+""+reg.get(e).getCodigo() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='"+reg.get(e).getMarca()+""+reg.get(e).getCodigo()+"'>"+
