...
import clases.Ohaus5;





public class HTMLOhaus5 {

	public static void main(String[] args) {
		
		
		//String ruta="C:\\casetes\\ohaus5.xls";
		String ruta="C:\\casetes\\ohaus5.xls";
		  ArrayList<Ohaus5> reg= new ArrayList();
		  Ohaus5 obj=new Ohaus5();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setTitulo(String.valueOf(num));
			    		// System.out.println(num);
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setTitulo(row.getCell(0).getStringCellValue());
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setCodigo(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDato1(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDato1(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDato2(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDato2(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDato3(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDato3(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDato4(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDato4(row.getCell(6).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDato5(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDato5(row.getCell(7).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setUnidad(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setUnidad(row.getCell(8).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setMarca(row.getCell(9).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
...
System.out.println(reg.size());
	...
	public static void CrearHtml(ArrayList<Ohaus5> reg){
...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
							...
							if(e==0) {
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'><h1 class='prodtitulo'>"+reg.get(e).getTitulo()+"</h1></br></div></div></div></div>");
							
							pw.println("<div class='tabla'><table><tbody>");
							pw.println("<tr class=''><th class='th1'>Producto</th><th class='th1'>Codigo</th><th class='th1'>detalle1</th><th class='th1'>detalle2</th><th class='th1'>detalle3</th><th class='th1'>detalle4</th><th class='th1'>detalle5</th><th class='th1'>Unidades</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
							}
				...
				pw.println("<td class='produccel'>"+reg.get(e).getPesoNeto()+"</td>");
					*/pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getNombreProducto()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDato1()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDato2()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDato3()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDato4()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getDato5()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getUnidad()+"</td>");
