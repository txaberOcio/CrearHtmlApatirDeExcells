...
public class HTMLTermoreactores {
	...
	public static void main(String[] args) {
		...
		String ruta="C:\\casetes\\termoreactoresparaDQO.xls";
				...
				for(int e=0;e<reg.size();e++){
					...
					pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
						...
						anterior =reg.get(e).getTipo();
							...
							pw.println("<div class='titulito' >"+reg.get(e).getNombreProducto()+"</div></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getCodigo());
