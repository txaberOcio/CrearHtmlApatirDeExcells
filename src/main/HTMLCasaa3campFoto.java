...
public class HTMLCasaa3campFoto {

	public static void main(String[] args) {
	//liebherpro
		//String ruta="C:\\casetes1\\BATA DE LABORATORIO.xls";
		//String ruta="C:\\casetes1\\Mecherosauxi.xls";
		//String ruta="C:\\casetes1\\calentadorAuxi.xls";
		//String ruta="C:\\casetes1\\mantaSelecta.xls";
		String ruta="C:\\casetes1\\supercongeladoresinfri.xls";
