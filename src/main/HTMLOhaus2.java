...
import clases.Ohaus2;





public class HTMLOhaus2 {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\ohaus2.xls";
		  ArrayList<Ohaus2> reg= new ArrayList();
		  Ohaus2 obj=new Ohaus2();	
			     ...
			     try{
			    	 ...
			    	 try {
			    		...
			    		// System.out.println(num);
			    		 ...
			    		 try {
			    		 obj.setTipo(row.getCell(0).getStringCellValue());
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setDescTipo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDescTipo(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setModeloUnidad(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setModeloUnidad(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDetallesUnidad(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDetallesUnidad(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setGrupo(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setFoto(row.getCell(6).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
...
System.out.println(reg.size());
	...
	public static void CrearHtml(ArrayList<Ohaus2> reg){
...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
							...
							pw.println("</table><div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'><h1 class='prodtitulo'>"+reg.get(e).getTipo()+"</h1>"+reg.get(e).getDescTipo()+".</br></div></div></div></div>");
							
							
							}
							pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7'>"+reg.get(e).getDetallesUnidad()+"</div><div class='col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5'><img  class=''height='250px' width='100%' SRC='fotoproducto2/"+reg.get(e).getFoto()+".jpg'></div></div></div>");
						
							
					
				
			pw.println("<tr class=''>");
				pw.println("<td class='produccel'>Codigo:&nbsp;&nbsp;"+reg.get(e).getCodigo()+"</td>");
				pw.println("<td class='codigo'>&nbsp;&nbsp;Modelo:&nbsp;&nbsp;"+reg.get(e).getModeloUnidad()+"</td>");
