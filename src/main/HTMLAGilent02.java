...
public class HTMLAGilent02 {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\Agilent01.xls";
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setDescripcion(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    		 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setUnidades(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setFoto(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			      reg.add(obj);
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				//aqui empiezo a mter mis cosas
					...
					//fincontenido
					//tabla
				pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-9'><h1 class='prodtitulo2'>HC-C18(2) and TC-C18(2)\r\n</h1>A more retentive C18 column for analytical HPLC and UHPLC with a higher carbon load and superior peak shape for basic compounds.</br></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-3'><img src='fotoproducto/1.jpg' class='producto'></div></div></div>");
				...
				pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Descripción</th><th class='th1'>Unidades</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
					...
					for(int e=0;e<reg.size();e++){
						...
						if(reg.get(e).getFoto().equals("a")){
							...
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-9'><h1 class='prodtitulo2'>"+reg.get(e).getCodigo()+"</h1>"+reg.get(e).getDescripcion()+".</br></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-3'><img src='fotoproducto/"+reg.get(e+1).getFoto()+".jpg' class='producto'></div></div></div>");
							pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
							pw.println("<div class='tabla'><table><tbody>");
							pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Descripción</th><th class='th1'>Unidades</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
						}else {
				...
				pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td><td class='produccel'>"+reg.get(e).getDescripcion()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getUnidades()+"</td>");
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'AG"+reg.get(e).getCodigo() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='AG"+reg.get(e).getCodigo()+"'>"+
