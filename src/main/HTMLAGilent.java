...
public class HTMLAGilent {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\Agilent8.xls";
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setTipo(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) {
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setMaterial(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 
			    		 try{
			    			 obj.setMaterial(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 int num=(int) row.getCell(4).getNumericCellValue();
			    		 obj.setColor(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 
			    		 try{
			    			 obj.setColor(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try{
			    			 obj.setUnidades(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			      reg.add(obj);
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	for(int h=0;h<reg.size();h++) {
		...
		System.out.println(reg.get(h).getMaterial());
		System.out.println(reg.get(h).getTipo());
	...
	public static void CrearHtml(ArrayList<Agilent> reg){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				...
				pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Color</th><th class='th1'>Material</th><th class='th1'>tipo</th><th class='th1'>Unidades</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");

					for(int e=0;e<reg.size();e++){
						
							pw.println("<tr class='inpar2'><td colspan='4'>");
							pw.println(reg.get(e).getDescripcion()+"</td><td></td><td></td><td></td><td></td><td></td><td></td></tr>");
				pw.println("<tr class='inpar'>");
				pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td><td class='produccel'>"+reg.get(e).getColor()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getMaterial()+"</td><td class='produccel'>"+reg.get(e).getTipo()+"</td>");
