...
public class HTMLOhaus3 {

	public static void main(String[] args) {
		
		
		//String ruta="C:\\casetes\\ohaus.xls";
		String ruta="C:\\casetes\\analizadores humedad.xls";
		  ArrayList<Ohaus> reg= new ArrayList();
		  Ohaus obj=new Ohaus();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setModelo(String.valueOf(num));
			    		// System.out.println(num);
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setModelo(row.getCell(0).getStringCellValue());
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setGrupoModelo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setGrupoModelo(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setNombreGrupoModelo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setNombreGrupoModelo(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setDescripcionGrupoModelo(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setDescripcionGrupoModelo(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setCodigo(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setNombreProducto(row.getCell(5).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
			    		 int num=(int) row.getCell(6).getNumericCellValue();
			    		 obj.setTipoValanza(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setTipoValanza(row.getCell(6).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
			    		 int num=(int) row.getCell(7).getNumericCellValue();
			    		 obj.setPesoNeto(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setPesoNeto(row.getCell(7).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }	
			    	 try {
			    		 int num=(int) row.getCell(8).getNumericCellValue();
			    		 obj.setPrimero(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setPrimero(row.getCell(8).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			      reg.add(obj);
...
System.out.println(reg.size());
	...
	public static void CrearHtml(ArrayList<Ohaus> reg){
...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
						...
						if(reg.get(e).getPrimero().equals("a")){
							if(e!=0) {
							pw.println("</tbody></table></div></div></div></div>");}
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-7'><h1 class='prodtitulo'>"+reg.get(e).getNombreGrupoModelo()+"</h1>"+reg.get(e).getDescripcionGrupoModelo()+".</br></div><div class='col-xs-12 col-sm-12 col-md-5 col-lg-5 col-xl-5'><img  class=''height='250px' width='100%' SRC='fotoproducto/"+reg.get(e).getModelo()+".jpg'></div></div></div></div>");
							pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
							pw.println("<div class='tabla'>"+reg.get(e).getTipoValanza() +"<table><tbody>");
							pw.println("<tr class=''><th class='th1'>Modelo</th><th class='th1'>Codigo</th><th class='th1'>Detalles</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
						}
							if(numerito%2==0) {
				...
				/*
				pw.println("<td class='produccel'>"+reg.get(e).getModelo()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getNombreProducto()+"</td>");
				pw.println("<td class='produccel'>"+reg.get(e).getPesoNeto()+"</td>");
					*/
							pw.println("<td class='produccel'>"+reg.get(e).getModelo()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getNombreProducto()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getPesoNeto()+"</td>");		
				//Codigo,Largura,Diametro,Unidades,Espesor.Formato,Tubo,Precio,Comprar
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'"+reg.get(e).getNombreProducto() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='"+reg.get(e).getNombreProducto()+"'>"+
