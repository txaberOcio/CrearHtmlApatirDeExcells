...
public class HTMLCasaa4campos {

	public static void main(String[] args) {
		//String ruta="C:\\casetes1\\termometros digitaltesto.xls";
		//String ruta="C:\\casetes1\\termometros digitaleslab.xls";
		//String ruta="C:\\casetes1\\termometros infrarrojostesto.xls";
		//String ruta="C:\\casetes1\\termometros infrarrojosLabprocess.xls";
		//String ruta="C:\\casetes1\\puntasSorbio.xls";
		String ruta="C:\\casetes1\\calenlab.xls";
		//String ruta="C:\\\\casetes1\\sondas temperaturaTesto.xls";
