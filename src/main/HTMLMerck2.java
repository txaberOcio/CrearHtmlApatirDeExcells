...
public class HTMLMerck2 {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\merck5.xls";
		   Merck reg= new Merck();
...
//enlace=nombre codigo=codigo descripcion= peso
	...
	public static void CrearHtml(Merck listaRegistrosDefinitiva){
		...
		String cod, chapter, subchapter,nombre;
			...
			try {
				fichero = new FileWriter("C:\\Users\\PQNSV2\\Desktop\\reactivosykitsdepcr.jsp");
				...
				pw.println("</td>");
				pw.println("<td class='produccel'><div id=\"divCarga"+e+"\" name=\"divCarga"+e+"\"> </div><div id='borrar"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCarga"+e+"`,'ME"+listaRegistrosDefinitiva.getLista().get(e).getCodigo() +"','borrar"+e+"')\">Consultar precio</div></td>"+
