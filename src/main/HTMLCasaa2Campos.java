...
public class HTMLCasaa2Campos {

	public static void main(String[] args) {
		//String ruta="C:\\casetes1\\puntasDurbizz.xls";
		//String ruta="C:\\casetes1\\jeringas.xls";
		String ruta="C:\\casetes1\\agujas.xls";
			...
			try {
				...
				for(int e=0;e<reg.size();e++){
					...
					pw.println("<div class='container'><div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'>");
							...
							pw.println("</div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img width='200px' height='200px' src='fotoproducto/"+reg.get(e).getCodigo().toUpperCase());
							pw.println(".png'>");
							pw.println("</div></div></div>");						
