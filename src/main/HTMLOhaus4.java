...
public class HTMLOhaus4 {

	public static void main(String[] args) {
		
		
		//String ruta="C:\\casetes\\ohaus4.xls";
		String ruta="C:\\casetes\\ohaus4.xls";
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setNombreGrupo(row.getCell(2).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 try {
			    		 obj.setNombreProducto(row.getCell(3).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
			    	 try {
			    		 ...
			    		 obj.setLetra(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setLetra(row.getCell(4).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    	 }
...
int numerito=2;
					...
					for(int e=0;e<reg.size();e++){
						...
						if(reg.get(e).getLetra().equals("a")){
							if(e==0) {
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12'><h1 class='prodtitulo'>"+reg.get(e).getTitutloGeneral()+"</h1></br></div></div></div></div>");

							}
							if(e!=0) {
							pw.println("</tbody></table></div></div></div></div>");}
							pw.println("<div class='tabla'>"+reg.get(e).getNombreGrupo() +"<table><tbody>");
							pw.println("<tr class=''><th class='th1'>Foto</th><th class='th1'>Codigo</th><th class='th1'>Producto</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
						}
							if(numerito%2==0) {
				...
				pw.println("<td class='produccel'>"+reg.get(e).getPesoNeto()+"</td>");
					*/pw.println("<td class='produccel'><img  class=''height='100px'width='100' width='100%' SRC='fotoproducto/ACC_"+reg.get(e).getCodigo()+"_DMX-ID_4294971416_WebShop.jpg'>");
							pw.println("<td class='produccel'>"+reg.get(e).getCodigo()+"</td>");
							pw.println("<td class='produccel'>"+reg.get(e).getNombreProducto()+"</td>");
