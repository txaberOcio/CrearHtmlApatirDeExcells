...
import clases.MedioDeMontage;



public class HTMLMedioDeMontage {

	public static void main(String[] args) {
		
		
		String ruta="C:\\casetes\\MedioDeMontage.xls";
		  ArrayList<MedioDeMontage> reg= new ArrayList();
		  MedioDeMontage obj=new MedioDeMontage();	
		  ...
		  do{
			     ...
			     try{
			    	 ...
			    	 try {
			    		 ...
			    		 obj.setNombre(String.valueOf(num));
			    	 }catch(Exception e) {
			    		 try {
			    		 obj.setNombre(row.getCell(1).getStringCellValue());
			    		 }catch(Exception a) { 
			    		 }
			    		 }
...
/*
	...
	public static void CrearHtml(ArrayList<MedioDeMontage> reg){
			...
			try {
				...
				pw.println("<%@ page language=\"java\" contentType=\"text/html; charset=UTF-8\"\r\n" + 
					...
					for(int e=0;e<reg.size();e++){
						System.out.println(e+" "+reg.get(e).getCodigo()+" "+reg.get(e).getNombre());
							pw.println("<div class='container'> <div class='row' id='linea'><div class='col-xs-12 col-sm-12 col-md-8 col-lg-8 col-xl-8'><h1 class='prodtitulo'>"+reg.get(e).getNombre()+"</h1></br></div><div class='col-xs-12 col-sm-12 col-md-4 col-lg-4 col-xl-4'><img  width='150px' height='150px'src='fotoproducto/"+(e+1)+".jpg' class=''></div></div></div>");
							...
							pw.println("<tr class=''><th class='th1'>Codigo</th><th class='th1'>Precio</th><th class='th1'>Comprar</th></tr>");
							...
							"<div id='borrarr"+e+"' class='consultapre' onclick=\"cargarExterno3(`divCargar"+e+"`,'CEL"+reg.get(e).getCodigo() +"','borrarr"+e+"')\">Consultar precio</div></td>"+
							"<td class='comprar'><form name='comprar' action='/es/pedido/tramitaPedido.jsp' method='post'>"+
							"<input type='hidden' name='numLineas' value='1'><input type='hidden' name='linea1' value='CEL"+reg.get(e).getCodigo()+"'>"+
